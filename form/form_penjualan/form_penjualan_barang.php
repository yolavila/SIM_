...
<form method="post" name="formPenjualan" action="proses_penjualan.php" id="formPenjualan" >	
<h1><b><font color=”#006400”>Penjualan Barang</b></font></h1>
<div class="button"> 
...
<a href="../../admin.php?menu=toko"  onclick="self.history.back()"><button type="button"><img src="../../images/exit3.png" alt="" title="" border="0" width="20px" height="20px">Exit</button></a>
               ...
               <table>
				<tr>
					...
					<td>: <input name="npa" id="npa" type="text" size="30" value="<?php echo $npax;?>"/></td>
					<td><input type="submit" name="caribtn" id="submit" value="Cari"> </td>
					
					<td><label>Keterangan</label></td>
					<td>:
					<? if ($status == "kredit"){?>
					<input type="radio" name="status" value="cash"/>Cash&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" name="status" value="kredit" checked="checked"/>Kredit
					<?}else{?>
					<input type="radio" name="status" value="cash" checked="checked"/>Cash &nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					<td><label>Tanggal Jual</td>
					<td>: <input type="text" name="tgl_jual" id="tanggal"  size="30" /> <value="<? echo $tanggal;?>"/></td>
				</tr>	
