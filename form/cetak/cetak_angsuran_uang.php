...
function Header()
{
    ...
    $this->Cell(150);
    // Title
    $this->Cell(30,10,'Laporan Sisa Angsuran Uang',0,0,'C');
...
while($row = mysql_fetch_array($result))
{
	...
	$instansi = $row['instansi'];
				...
				$qsisa = mysql_query("SELECT SUM(angsuran) AS tot_angsuran, count(angsuran) AS tot_cicilan FROM angsuran_uang where no_pinjam = '$noPinjam' and bayar = '0'")or die(mysql_error());
