<?php
	...
	if (isset($_POST['sbtn'])){
		...
		$str="select * from anggota where level='4' AND tipe='p'";
	}
...
<fieldset>
					<h1><b><font color=”#006400”>Informasi Anggota Non Aktif</b></font></h1>
					<div id="contact_form">
					<div id="main">
					</div>
...
<div id="content">
	...
	<thead>
	<tr bgcolor="#3CB371">
	<th width="40">NPA</th><th width="160">Nama</th><th width="230">Alamat</th><th width="150">Instansi</th><th width="70">Kota</th><th width="50">JK</th>
	</tr> 
	</thead>
