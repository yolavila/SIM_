...
<tr><td width="50%">
	...
	<thead>
	<tr bgcolor="#3CB371">
	<th width="4%">No.Pinj</th><th width="4%">NPA</th><th width="12%">Nama</th><th width="10%">Instansi</th><th width="6%">Tanggal Pinjam</th><th width="6%">Jenis Bayar</th><th width="6%">Jenis Pinjaman</th><th width="8%">Pinjaman Pokok</th><th width="4%">Jasa (%)</th><th width="6%">X Angsuran</th><th width="6%">Angsuran</th><th width="6%">Total Jasa</th><th width="6%">Total Angsuran</th><th width="6%">Tgl Mulai</th><th width="6%">Tgl Selesai</th><?php if($hapus){ ?><th width="3%">Delete</th><?php } ?>
	</tr> 
		</thead>
	...
	<tr class="gradeA">
				...
				<td><a href="pinjaman_uang.php?action=update&npa=<?php echo $ret['npa'];?>" style="text-decoration:none"><?php echo $ret['nama']; ?></td>
