...
<div id="content">
	...
	$(function(){
		$("a.edit").click(function(){
			...
			return false;
				...
				<fieldset>
					<h1><b><font color=”#006400”>Tampil Angsuran Uang</b></font></h1>
					<div id="contact_form">
					<div id="main">
					</div>
	...
	<tr class="gradeA">
				...
				<td>
				<?php
				$qsisa = mysql_query("SELECT SUM(angsuran) AS tot_angsuran, count(angsuran) AS tot_cicilan FROM angsuran_uang where no_pinjam = '".$ret['no_pinjam']."' and bayar = '0'")or die(mysql_error());
				...
				{
					$sisa['tot_angsuran'];
					$sisaa= " ".number_format($sisa['tot_angsuran'],0, ',', '.');
					echo $sisaa ;
				}
				?>
				</td>
