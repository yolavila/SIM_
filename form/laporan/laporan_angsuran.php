...
{
var x=document.forms["laporanAngsuran"]["tahun"].value;
if (x==null || x=="")
  {
...
<h1><b><font color=”#006400”>Laporan Sisa Angsuran</b></font></h1>
<body bgcolor="#F5F5F5">
...
<div id="content">
	...
	<?php
		...
		?> 
<form name="laporanAngsuran" action="../cetak/cetak_angsuran_uang.php" method="POST" target="_blank" onsubmit="return validateForm()">
<table>
	<tr>
	...
	<td>
		...
		<?php
			$thn = mysql_query("select distinct year(tgl_pinjam) as tahun from pinjaman_uang") or die(mysql_error());
		...
		<td>
		<input type="hidden" name="jdlLaporan" value="Laporan Pinjaman Anggota" />
<input type="hidden" name="nmTabel" value="pinjaman_uang" />
