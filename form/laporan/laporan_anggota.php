<?php
	...
	$str="select * from anggota where tipe='a'";
...
<h1><b><font color=”#006400”>Laporan Daftar Anggota</b></font></h1>
<body bgcolor="#F5F5F5">
...
<div id="content">
	...
	<?php
		...
		$res=mysql_query($str) or die("query gagal dijalankan pada tampil anggota");
		?> 
<form name="laporanAnggota" action="../cetak/cetak_anggota.php" method="POST" target="_blank" onsubmit="return validateForm()">
<table>
	<tr>
