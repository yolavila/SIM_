<?php
	...
	if (isset($_POST['sbtn'])){
		...
		$str = "SELECT * FROM pembelian WHERE $opsi LIKE '%$search%'";
		//echo $str;
	}else{
		$str="select * from pembelian";
	}
...
{
var x=document.forms["laporanBeli"]["tahun"].value;
if (x==null || x=="")
  {
...
<h1><b><font color=”#006400”>Laporan Pembelian Barang</b></font></h1>
<body bgcolor="#F5F5F5">
...
<div id="content">
	...
	<?php
		...
		?> 
<form name="laporanBeli" action="../cetak/cetak_pembelian.php" method="POST" target="_blank" onsubmit="return validateForm()">
<table>
	<tr>
	...
	<td>
		...
		<?php
			$thn = mysql_query("select distinct year(tgl) as tahun from pembelian") or die(mysql_error());
		...
		<td>
		<input type="hidden" name="jdlLaporan" value="Laporan pembelian Anggota" />
<input type="hidden" name="nmTabel" value="pembelian" />
