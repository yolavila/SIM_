<?php
	...
	$str="select * from return_penjualan";
	$res=mysql_query($str) or die("query gagal dijalankan pada tampil return_penjualan");
...
{
var x=document.forms["laporanReturn"]["tahun"].value;
if (x==null || x=="")
  {
...
<h1><b><font color=”#006400”>Laporan Return Penjualan</b></font></h1>
<body bgcolor="#F5F5F5">
...
<div id="content">
	...
	<?php
		...
		?> 
<form name="laporanReturn" action="../cetak/cetak_return_jual.php" method="POST" target="_blank" onsubmit="return validateForm()">
<table>
	<tr>
	...
	<td>
		...
		<?php
			$thn = mysql_query("select distinct year(tgl) as tahun from return_penjualan") or die(mysql_error());
		...
		<td>
		<input type="hidden" name="jdlLaporan" value="Laporan return_penjualan Anggota" />
<input type="hidden" name="nmTabel" value="return_penjualan" />
