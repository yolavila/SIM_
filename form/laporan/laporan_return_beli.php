<?php
	...
	$res=mysql_query($str) or die("query gagal dijalankan pada tampil return_pembelian");
...
<h1><b><font color=”#006400”>Laporan Return Pembelian</b></font></h1>
<body bgcolor="#F5F5F5">
...
<div id="content">
	...
	<?php
		...
		?> 
<form name="laporanReturn" action="../cetak/cetak_return_beli.php" method="POST" target="_blank" onsubmit="return validateForm()">
<table>
	<tr>
	...
	<td>
		...
		<?php
			$thn = mysql_query("select distinct year(tgl) as tahun from return_pembelian") or die(mysql_error());
		...
		<td>
		<input type="hidden" name="jdlLaporan" value="Laporan return_pembelian Anggota" />
<input type="hidden" name="nmTabel" value="return_pembelian" />
