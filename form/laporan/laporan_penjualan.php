...
{
var x=document.forms["laporanPenjualan"]["tahun"].value;
if (x==null || x=="")
  {
...
<h1><b><font color=”#006400”>Laporan Penjualan</b></font></h1>
<body bgcolor="#F5F5F5">
...
<div id="content">
	...
	<?php
		...
		?> 
<form name="laporanPenjualan" action="../cetak/cetak_penjualan.php" method="POST" target="_blank" onsubmit="return validateForm()">
<table>
	<tr>
	...
	<td>
		...
		<?php
			$thn = mysql_query("select distinct year(tgl_jual) as tahun from penjualan") or die(mysql_error());
		...
		<td>
		<input type="hidden" name="jdlLaporan" value="Laporan penjualan Anggota" />
<input type="hidden" name="nmTabel" value="penjualan" />
