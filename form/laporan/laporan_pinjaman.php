...
{
var x=document.forms["laporanPinjam"]["tahun"].value;
if (x==null || x=="")
  {
...
<h1><b><font color=”#006400”>Laporan Pinjaman Anggota</b></font></h1>
<body bgcolor="#F5F5F5">
...
<div id="content">
	...
	<?php
		...
		?> 
<form name="laporanPinjam" action="../cetak/cetak_pinjaman.php" method="POST" target="_blank" onsubmit="return validateForm()">
<table>
	<tr>
