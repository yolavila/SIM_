...
{
var x=document.forms["laporanSimpan"]["tahun"].value;
if (x==null || x=="")
  {
...
<h1><b><font color=”#006400”>Laporan Simpanan Anggota</b></font></h1>
<body bgcolor="#F5F5F5">
...
<div id="content">
	...
	<?php
		...
		?> 
<form name="laporanSimpan" action="../cetak/cetak_simpanan.php" method="POST" target="_blank" onsubmit="return validateForm()">
<table>
	<tr>
	...
	<td>
		...
		<?php
			$thn = mysql_query("select distinct year(tgl) as tahun from simpanan") or die(mysql_error());
		...
		<td>
		<input type="hidden" name="jdlLaporan" value="Laporan Simpanan Anggota" />
<input type="hidden" name="nmTabel" value="simpanan" />
