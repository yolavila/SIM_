...
<td><input type="button" name="submit" value="exit" onclick="self.history.back()" img></td>
                       ...
                       <h2>Form Stok Opname</h2>
                <table>
				<tr>
					<td><label>No.SO</label></td>
					<td>: <input name="npa" type="text" size="30" /></td>
					<td><input type="button" value="Search"></td>
									
					<td><label>Tgl</label></td>
					<td>: <select name="tanggal_masuk">
	<option value>Day:
	<option value="1">1
	<option value="2">2
	<option value="3">3
	...
	<option value="2020">2020
				...
				<tr>
					<td><label>No.Return</label></td>
					<td>: <input name="nama" type="text" size="30" /></td>
				</tr>
				<tr>
				<td><label>Keterangan</label></td>
				<td>:<input type="radio" name="jk" value="laki-laki"/>SO Masuk <br>
					&nbsp;<input type="radio" name="jk" value="perempuan"/>SO Keluar
					</td>
				</table>	
				</div>
				</fieldset>				
...
<div id="kontenbawah">
<table frame=hsides width="950" border="1">
